...
def add_formatter(logger_config, name: str, format_string: str | DefaultFormatters) -> str:
...
def add_json_formatter(logger_config, name: str, formatter: JsonFormatters) -> str:
    logger_config["formatters"][name] = {
